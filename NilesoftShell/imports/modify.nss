...
remove(find="Open folder as IntelliJ IDEA Project")
remove(find="cut|copy|paste")
remove(find="delete|rename")
remove(find="Personalize")
remove(find="Upload to TeraBox")
remove(find="Back up the folder automatically")
remove(find="Add to VLC media player's Playlist")
remove(find="Play with VLC media player")
remove(find="Share with Zalo")
remove(find="Scan with Microsoft Defender...")
remove(find="Pin to Start")
remove(find="Pin to Quick Access")